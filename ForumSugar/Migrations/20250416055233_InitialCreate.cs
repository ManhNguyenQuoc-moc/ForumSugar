    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedbackChatBots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeedbackChatBots_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetAchievements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GetAchievements_Achievements_AchievementId",
                        column: x => x.AchievementId,
                        principalTable: "Achievements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GetAchievements_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedbackChatBots_UserId",
                table: "FeedbackChatBots",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GetAchievements_AchievementId",
                table: "GetAchievements",
                column: "AchievementId");

            migrationBuilder.CreateIndex(
                name: "IX_GetAchievements_UserId",
                table: "GetAchievements",
                column: "UserId");
